  ...
  return (
    <main className="bg-gray-950 text-white">
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto">
        ...
        >
          I started my journey as a curious learner in software development and
          grew into a Full Stack Developer specializing in the{" "}
      ...
      <section className="py-20 px-6 bg-gray-900">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-sm">
              Delivered e-commerce websites, chat systems, and custom platforms
              for businesses, achieving 100% client satisfaction.
            </p>
          </motion.div>
